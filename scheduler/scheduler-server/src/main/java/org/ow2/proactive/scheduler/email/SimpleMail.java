...
public class SimpleMail {
    ...
    public static void send(String from,String to,String subject,ProactiveInfo proactiveInfo) {
        ...
        mailInfo.setMailServerHost(properties.getProperty(SMTP_HOST_PROPERTY_NAME));
        mailInfo.setMailServerPort(DEFAULT_SMTP_PORT);
        mailInfo.setValidate(false);
        mailInfo.setFromAddress(from);
        mailInfo.setToAddress(to);
        mailInfo.setSubject(subject);
        mailInfo.setContent(proactiveInfo.toHtmlString());
